...
import { SIGN_UP, SIGN_IN, SIGN_OUT, GET_USER } from '@/apollo/queries/auth.js';
...
import {
  ...
  CREATE_POST,
  GET_HIGHLIGHT,
} from '@/apollo/queries/forum.js';

export const useGetHighlight = (options) => {
  console.log(options);
  useQuery(GET_HIGHLIGHT, options);
};
